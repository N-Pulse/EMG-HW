...
(library Library_1
	...
	(compDef "LD1117DT18TR" (originalName "LD1117DT18TR") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "VIN") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "VOUT_(TAB)") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/CD00000544.pdf")
		(attr "Height" "2.4 mm")
	)
